...
from models import State, Command
from util import (
    display_go_list,
    display_help,
        ...
        case Command.go:
            ...
            match destination:
                ...
                case "teacher_room_3":
                    ...
                    return state
                case "project_room_3" | "teachers_room_1" | "teachers_room_2" :
                    print("This door is locked")
                    return state
                case "equinox_students_society" :
                    print(
                        "You approach the door of the Equinox Students Society.\n"
                        "As you turn the handle, you find the entrance completely blocked by a chaotic pile of chairs, tables, and vending machines.\n"
                        "From behind the barricade, frantic voices shout: 'Who’s there?!' and 'Go away! We’re not opening the door!'\n"
                        "You push and shove, trying to force your way through the stacked furniture, but it won’t budge.\n"
                        "Realizing it’s impossible to pass, you step back reluctantly and return to the North Corridor.\n"
                    )
                    return state
                case _:
                    display_invalid_command()
